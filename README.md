# Erdős Distinct Distances (n=5) — Canonical Lane Mathlib

Mathlib-backed Canonical Lane formalization package for the Erdős Distinct Distances (n=5).

## Clean-clone replay

```bash
git clone https://github.com/HautevilleHouse/erdos-dist-5-mathlib.git
cd erdos-dist-5-mathlib
lake exe
lake build
```
